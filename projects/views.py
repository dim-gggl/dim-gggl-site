...
class ProjectListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset = (
            ...
            .only(
                'id', 'slug', 'title', 'tagline', 'primary_color', 
                'secondary_color', 'featured_image', 'order', 'completed_at',
                'is_featured', 'category__name', 'category__slug'
            )
        )
...
class ProjectDetailView(DetailView):
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .prefetch_related("technologies", gallery_prefetch)
        )
